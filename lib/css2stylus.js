    ...
    _parse: function () {
      ...
      this.css
        ...
        .replace(/@media[^@]+/gi, function (group, selector, declaration) {
          ...
          // var MediaSelector = group.replace(/@media[^{]+/gi, function (group, selector, declaration) {
          //   console.log('## 2. Analyte: ##');
          //   console.log(Analyte);
          //   console.log('## 3. selector: ##');
          //   console.log(selector);
          //   console.log('## 4. declaration: ##');
          ...
          var Analyte = group;
          var output = Analyte.replace(/\{[^\{]+\}/g, function (Analyte, selector, declaration) {
            console.log('## 2. Analyte: ##');
            console.log(Analyte);
            console.log('## 3. selector: ##');
            console.log(selector);
          ...
          // Find selectors blocks
          var output = output.replace(/[^(\%11\%){\n]+\%11\%/g, function (Analyte, selector, declaration) {
            console.log('## 2. Analyte: ##');
            console.log(Analyte);
            console.log('## 3. selector: ##');
            console.log(selector);
          ...
          // Address any content not inside the '@media ... {...}'
